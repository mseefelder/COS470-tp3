...
/lcg/home/mseefelder/workspace/resources/lua-5.3.3/install/bin/lua coordinator.lua &

## now loop through the above array
for i in "${arr[@]}"
do
   echo "$i"
   /lcg/home/mseefelder/workspace/resources/lua-5.3.3/install/bin/lua client.lua "$i" $RANDOM &
done